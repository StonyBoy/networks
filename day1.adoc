...
----
net 10.99.y.1/zz brd 10.99.1.255 scope global eth_mgmt
----
...
Hvad hedder disse pakker i WireShark, og hvad indeholder de?
Hvad er MAC adresserne på de to devices?
